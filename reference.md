...
<details><summary><code>client.assets.<a href="/src/api/resources/assets/client/Client.ts">filesList</a>({ ...params }) -> Airtop.FilesResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.assets.<a href="/src/api/resources/assets/client/Client.ts">filesCreate</a>({ ...params }) -> Airtop.EnvelopeCreateFileV1EnvelopeDefaultMeta</code></summary>
<dl>
<dd>
...
<details><summary><code>client.assets.<a href="/src/api/resources/assets/client/Client.ts">filesGet</a>(id) -> Airtop.EnvelopeGetFileV1EnvelopeDefaultMeta</code></summary>
<dl>
<dd>
...
<details><summary><code>client.assets.<a href="/src/api/resources/assets/client/Client.ts">filesDelete</a>(id) -> void</code></summary>
<dl>
<dd>
...
```typescript
await client.assets.filesDelete("id");
```
